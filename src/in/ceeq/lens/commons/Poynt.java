...
public class Poynt {
	...
	public static double getSkewAngle(List<Poynt> corners) {
		...
		skewAngle += Math.atan2(corners.get(Constants.TOP_RIGHT).getY() - corners.get(Constants.TOP_LEFT).getY(),
				corners.get(Constants.TOP_RIGHT).getX() - corners.get(Constants.TOP_LEFT).getX());
		skewAngle += Math.atan2(corners.get(Constants.BOTTOM_RIGHT).getX() - corners.get(Constants.BOTTOM_LEFT).getX(), corners.get(Constants.BOTTOM_RIGHT).getX()
				- corners.get(Constants.BOTTOM_LEFT).getX());
